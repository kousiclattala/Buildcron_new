...
class QualityInspectionScreen extends React.Component {
  constructor() {
    super();
    this.state = {
      qualityData: [],
  ...
  selectionOfQI(item) {
    ...
    // console.log('selected checklist -->', item);
    ...
    return (
      <View style={[{backgroundColor: '#FFF', flex: 1}]}>
        ...
        {/* <FlatList
          ...
          renderItem={({item, index}) => this.qualityInspectionData(item)}
          extraData={this.props}
          style={[Styles.mBtm20]}
        /> */}

        {/* {this.props.SignupState.selectedProject.checklists.map((list) => {
          if (list.typee === 'Quality') {
        ...
        {this.props.SignupState.selectedProject.length == 0 ? (
        ...
        ) : this.props.SignupState.selectedProject.quality_checklist.length ==
          0 ? (
          <View
            style={{
              flex: 1,
          ...
          this.props.SignupState.selectedProject.quality_checklist.map(
            (list, index) => {
