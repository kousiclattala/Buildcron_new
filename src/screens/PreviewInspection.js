...
class PreviewInspection extends React.Component {
  constructor() {
    super();
    this.state = {
      mode: '',
  ...
  sendDataToBack = async (data, file) => {
    ...
    //     files.map((document) => {
    //       if (document.path == file.filePath) {
    //         // console.log('document from rnfs --->', document);
    //       }
    //     });
    //   })
...
export default connect(mapStateToProps, mapDispatchToProps)(PreviewInspection);
